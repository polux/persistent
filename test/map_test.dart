...
bool testHashCode(PersistentMap<Element, int> map1, PersistentMap<Element, int> map2) {
  return (map1 != map2) || (map1.hashCode == map2.hashCode);
}

bool testInsert(Map<Key, int> map, Key key, int value) =>
